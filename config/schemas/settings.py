...
class Settings(BaseSettings):
    ...
    jira_projects: Optional[List[str]] = Field(
        default=None,
    ...
    jira_scriptrunner_endpoint: Optional[str] = Field(
    ...
    openproject_api_key: Optional[str] = Field(
    ...
    openproject_server: Optional[str] = Field(
        default="sobol.nr",
        description="SSH server hostname"
    )
    openproject_user: Optional[str] = Field(
        default="sebastian.mendel",
        description="SSH username"
    )
    openproject_container: Optional[str] = Field(
    ...
    test_mock_mode: bool = Field(
        default=False,
        description="Mock mode flag"
    )
    use_mock_apis: bool = Field(
        default=False,
        description="Use mock APIs flag"
    )
    ...
    def validate_openproject_api_token(cls, v: str) -> str:
        ...
        if len(v) < 10:
            raise ValueError('OpenProject API token must be at least 10 characters long')
        return v
    ...
    def get_jira_config(self) -> dict:
        ...
        return {
            ...
            } if self.jira_scriptrunner_enabled else None
        }
