...
class OpenProjectClient:
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        from src.clients.openproject_bulk_create_service import OpenProjectBulkCreateService
        ...
        from src.clients.openproject_work_package_custom_field_service import (
