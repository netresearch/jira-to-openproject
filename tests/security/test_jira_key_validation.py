...
class TestJiraKeyValidation:
    ...
    def test_ua_migrator_validate_jira_key_accepts_valid_inputs(self, ua_migrator, valid_key):
    ...
    def test_ts_migrator_validate_jira_key_accepts_valid_inputs(self, ts_migrator, valid_key):
    ...
    def test_ua_migrator_validate_jira_key_rejects_invalid_inputs(self, ua_migrator, invalid_key, description):
    ...
    def test_ts_migrator_validate_jira_key_rejects_invalid_inputs(self, ts_migrator, invalid_key, description):
        """Test that invalid/malicious JIRA keys are rejected by TS migrator"""
        with pytest.raises(ValueError):
            ts_migrator._validate_jira_key(invalid_key)

    def test_validate_jira_key_none_input(self, ua_migrator):
        """Test that None input is handled properly"""
        with pytest.raises(ValueError):
            ua_migrator._validate_jira_key(None)

    def test_validate_jira_key_error_messages_specific(self, ua_migrator):
    ...
    def test_validate_jira_key_boundary_conditions(self, ua_migrator):
    ...
    def test_validate_jira_key_regex_pattern_comprehensive(self, ua_migrator):
