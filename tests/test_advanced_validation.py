...
class TestValidationSummary:
    ...
    def test_validation_summary_add_result(self):
    ...
    def test_validation_summary_has_critical_errors(self):
...
class TestPreMigrationValidator:
    ...
    @pytest.mark.asyncio
    async def test_pre_migration_validator_creation(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_jira_data_missing_components(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_project_missing_fields(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_project_invalid_key(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_user_missing_fields(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_user_invalid_email(self):
...
class TestInFlightValidator:
    ...
    @pytest.mark.asyncio
    async def test_in_flight_validator_creation(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_duplicate_processing(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_data_integrity_missing_fields(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_data_integrity_type_mismatch(self):
...
class TestPostMigrationValidator:
    ...
    @pytest.mark.asyncio
    async def test_post_migration_validator_creation(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_completeness_mismatch(self):
        """Test validation of completeness with count mismatch."""
        validator = PostMigrationValidator()
        
        data = {
            "migrated_entities": [{"id": "1"}, {"id": "2"}]  # 2 entities
        }
        
        context = {
            "expected_count": 5  # Expected 5 entities
        }
    ...
    @pytest.mark.asyncio
    async def test_validate_accuracy_mismatch(self):
...
class TestValidationFramework:
    ...
    @pytest.mark.asyncio
    async def test_validation_framework_creation(self):
    ...
    @pytest.mark.asyncio
    async def test_add_validator(self):
    ...
    @pytest.mark.asyncio
    async def test_run_pre_migration_validation(self):
    ...
    @pytest.mark.asyncio
    async def test_save_validation_report(self, tmp_path):
...
class TestConvenienceFunctions:
    ...
    @pytest.mark.asyncio
    async def test_validate_pre_migration(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_in_flight(self):
    ...
    @pytest.mark.asyncio
    async def test_validate_post_migration(self):
