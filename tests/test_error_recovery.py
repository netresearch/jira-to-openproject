...
class TestErrorRecoverySystem:
    ...
    def test_initialization(self, error_recovery_system, temp_db_path) -> None:
    ...
    def test_create_checkpoint(self, error_recovery_system) -> None:
    ...
    def test_get_migration_status(self, error_recovery_system) -> None:
    ...
    def test_resume_migration(self, error_recovery_system) -> None:
    ...
    def test_circuit_breaker_functionality(self, error_recovery_system) -> None:
    ...
    def test_retry_logic(self, error_recovery_system) -> None:
    ...
    def test_execute_with_recovery(self, error_recovery_system) -> None:
    ...
    def test_execute_with_recovery_failure(self, error_recovery_system) -> None:
    ...
    def test_clear_migration_data(self, error_recovery_system) -> None:
