...
class TestSecurityValidatorNumericValidation:
    ...
    @pytest.mark.parametrize(
        ("param_name", "valid_value", "expected_type"),
        [
            ("batch_size", 100, int),
            ("max_workers", 4, int),
    ...
    def test_validate_numeric_parameter_valid_values(
        self,
        param_name,
        valid_value,
        expected_type,
    ...
    def test_validate_numeric_parameter_boundary_violations(
        self,
        param_name,
        invalid_value,
        expected_error,
    ...
    @pytest.mark.parametrize(
        ("param_name", "string_value", "expected_result"),
        [
            ("batch_size", "100", 100),
            ("max_workers", "8", 8),
            ("base_delay", "1.5", 1.5),
    ...
    def test_validate_numeric_parameter_string_coercion(
        self,
        param_name,
        string_value,
        expected_result,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                "batch_size",
                "100 ",
            ),  # trailing space should be stripped, but this tests malformed pattern
            ("max_workers", "abc"),
            ("base_delay", "1.2.3"),
            ("rate_limit_per_sec", "50%"),
        ],
    )
    def test_validate_numeric_parameter_malformed_strings(
        self,
        param_name,
        malformed_string,
    ) -> None:
    ...
    def test_validate_numeric_parameter_type_errors(
        self,
        param_name,
        invalid_type,
    ) -> None:
        ...
        assert "Type conversion failed" in str(
            exc.value,
        ) or f"got {type(invalid_type).__name__}" in str(exc.value)

    def test_validate_numeric_parameter_none_handling(self) -> None:
        ...
        result = SecurityValidator.validate_numeric_parameter(
            "batch_size",
            None,
            allow_none=True,
        )
    ...
    def test_validate_numeric_parameter_unknown_parameter(self) -> None:
...
class TestSecurityValidatorStringValidation:
    ...
    def test_validate_string_parameter_basic_validation(self) -> None:
    ...
    def test_validate_string_parameter_length_limits(self) -> None:
    ...
    def test_validate_string_parameter_sql_injection_detection(
        self,
        sql_payload,
    ) -> None:
    ...
    def test_validate_string_parameter_script_injection_detection(
        self,
        script_payload,
    ) -> None:
    ...
    def test_validate_string_parameter_path_traversal_detection(
        self,
        path_payload,
    ) -> None:
    ...
    @pytest.mark.parametrize(
        ("control_char_input", "expected_sanitized"),
        [
    ...
    def test_validate_string_parameter_control_char_sanitization(
        self,
        control_char_input,
        expected_sanitized,
    ) -> None:
    ...
    def test_validate_string_parameter_pattern_validation(self) -> None:
    ...
    def test_validate_string_parameter_type_validation(self) -> None:
        """Test that non-string types are rejected."""
        with pytest.raises(ConfigurationValidationError) as exc:
            SecurityValidator.validate_string_parameter("param", 123)
        assert f"string (got {int.__name__})" in str(exc.value)
...
class TestSecurityValidatorFilePathValidation:
    ...
    def test_validate_file_path_none_handling(self) -> None:
        """Test that None values are handled appropriately."""
        result = SecurityValidator.validate_file_path("config_path", None)
        assert result is None

    @patch("pathlib.Path.resolve")
    def test_validate_file_path_valid_paths(self, mock_resolve) -> None:
    ...
    @patch("pathlib.Path.resolve")
    def test_validate_file_path_security_checks(self, mock_resolve) -> None:
    ...
    @patch("pathlib.Path.resolve")
    def test_validate_file_path_path_traversal_prevention(self, mock_resolve) -> None:
    ...
    @patch("pathlib.Path.resolve")
    def test_validate_file_path_existence_checks(self, mock_resolve) -> None:
    ...
    @patch("pathlib.Path.resolve")
    def test_validate_file_path_absolute_requirement(self, mock_resolve) -> None:
    ...
    def test_validate_file_path_invalid_types(self) -> None:
        """Test rejection of invalid path types."""
        with pytest.raises(ConfigurationValidationError) as exc:
            SecurityValidator.validate_file_path("config_file", 123)
        assert f"string or Path (got {int.__name__})" in str(exc.value)

    @patch("pathlib.Path.resolve")
    def test_validate_file_path_resolution_errors(self, mock_resolve) -> None:
...
class TestSecurityValidatorResourceAllocation:
    ...
    def test_validate_resource_allocation_valid_combinations(self) -> None:
    ...
    def test_validate_resource_allocation_memory_exceeded(self) -> None:
    ...
    @patch("os.cpu_count")
    def test_validate_resource_allocation_cpu_oversubscription(
        self,
        mock_cpu_count,
    ) -> None:
        ...
        with pytest.raises(ConfigurationValidationError) as exc:
            SecurityValidator.validate_resource_allocation(
                batch_size=10,
                max_workers=10,
                memory_limit_mb=1024,  # 10 > 4*2
            )
        assert "system instability" in str(exc.value)
        assert "max_workers" in str(exc.value)

    @patch("os.cpu_count")
    def test_validate_resource_allocation_cpu_count_none(self, mock_cpu_count) -> None:
...
class TestSecurityValidatorTimingRelationships:
    ...
    def test_validate_timing_relationships_valid(self) -> None:
        """Test valid timing relationships."""
        # Basic valid relationship
        SecurityValidator.validate_timing_relationships(base_delay=1.0, max_delay=10.0)
    ...
    def test_validate_timing_relationships_base_exceeds_max(self) -> None:
    ...
    def test_validate_timing_relationships_base_below_min(self) -> None:
    ...
    def test_validate_timing_relationships_excessive_ratio(self) -> None:
        """Test rejection of excessive delay ratios."""
        with pytest.raises(ConfigurationValidationError) as exc:
            SecurityValidator.validate_timing_relationships(
                base_delay=0.001,
                max_delay=10.0,  # 10000x ratio
            )
...
class TestSecurityValidatorIntegration:
    ...
    def test_performance_config_validation_success(self) -> None:
    ...
    def test_performance_config_validation_failure(self) -> None:
    ...
    def test_batch_processor_validation_success(self) -> None:
    ...
    def test_batch_processor_validation_failure(self) -> None:
    ...
    def test_rate_limit_config_validation_success(self) -> None:
    ...
    def test_rate_limit_config_validation_failure(self) -> None:
    ...
    def test_configuration_validation_error_logging(self, mock_logger) -> None:
...
class TestValidateConfigurationDict:
    ...
    def test_validate_configuration_dict_success(self) -> None:
    ...
    def test_validate_configuration_dict_with_expected_keys(self) -> None:
        """Test configuration dictionary validation with expected keys."""
        config_dict = {"batch_size": 100, "max_workers": 4}

        # Should pass with all expected keys present
        result = validate_configuration_dict(
            config_dict,
            expected_keys=["batch_size", "max_workers"],
        )
        assert len(result) == 2
        ...
        with pytest.raises(ConfigurationValidationError) as exc:
            validate_configuration_dict(
                config_dict,
                expected_keys=["batch_size", "max_workers", "missing_key"],
            )
        assert "missing_key" in str(exc.value)

    def test_validate_configuration_dict_invalid_types(self) -> None:
    ...
    def test_validate_configuration_dict_numeric_validation(self) -> None:
        """Test that numeric parameters in dictionaries are properly validated."""
        config_dict = {"batch_size": 1000, "max_workers": 4}  # Above maximum

        with pytest.raises(ConfigurationValidationError):
            validate_configuration_dict(config_dict)

    def test_validate_configuration_dict_string_sanitization(self) -> None:
...
class TestSecurityValidatorErrorHandling:
    ...
    def test_configuration_validation_error_attributes(self) -> None:
    ...
    def test_security_validator_regex_patterns(self) -> None:
    ...
    @patch("os.cpu_count")
    def test_numeric_bounds_cpu_dependency(
        self,
        mock_cpu_count,
        cpu_count_value,
    ) -> None:
