...
class TestDataPreservationWorkflow:
    ...
    def test_run_with_data_preservation_no_entity_type(self, migration_with_preservation):
        ...
        assert not migration_with_preservation.state_manager.start_migration_record.called
        
    def test_run_with_data_preservation_successful_workflow(self, migration_with_preservation):
        """Test complete successful data preservation workflow."""
        # Mock snapshot creation
        migration_with_preservation.create_snapshot = Mock(return_value=Path("test-snapshot.json"))
        ...
        store_calls = migration_with_preservation.data_preservation_manager.store_original_state.call_args_list
    ...
    def test_run_with_data_preservation_skip_migration_no_changes(self, migration_with_preservation):
        """Test skipping migration when no changes are detected."""
        # Mock no changes detected
        migration_with_preservation.change_detector.detect_changes.return_value = ChangeReport(
            has_changes=False,
    ...
    def test_run_with_data_preservation_conflict_analysis_disabled(self, migration_with_preservation):
    ...
    def test_run_with_data_preservation_migration_failure(self, migration_with_preservation):
        """Test workflow when migration fails."""
        # Mock failed migration
        migration_with_preservation.run = Mock(return_value=ComponentResult(
            success=False,
        ...
        migration_with_preservation.state_manager.complete_migration_record.assert_called_once()
        complete_call = migration_with_preservation.state_manager.complete_migration_record.call_args
