...
class TestDataPreservationManager:
    ...
    def test_initialization(self, preservation_manager, temp_preservation_dir) -> None:
    ...
    def test_calculate_entity_checksum(self, preservation_manager) -> None:
    ...
    def test_store_original_state(self, preservation_manager) -> None:
    ...
    def test_detect_openproject_changes_unchanged(self, preservation_manager) -> None:
    ...
    def test_detect_openproject_changes_modified(self, preservation_manager) -> None:
    ...
    def test_detect_openproject_changes_created(self, preservation_manager) -> None:
    ...
    def test_detect_conflicts_no_manual_changes(self, preservation_manager) -> None:
    ...
    def test_detect_conflicts_with_field_conflicts(self, preservation_manager) -> None:
    ...
    def test_resolve_conflict_jira_wins(self, preservation_manager) -> None:
    ...
    def test_resolve_conflict_openproject_wins(self, preservation_manager) -> None:
    ...
    def test_resolve_conflict_merge_strategy(self, preservation_manager) -> None:
    ...
    def test_custom_merge_logic(self, preservation_manager) -> None:
    ...
    def test_create_backup(self, preservation_manager) -> None:
    ...
    def test_update_preservation_policy(self, preservation_manager) -> None:
    ...
    def test_analyze_preservation_status_no_client(self, preservation_manager) -> None:
    ...
    def test_timestamps_use_utc(self, mock_datetime, preservation_manager) -> None:
    ...
    def test_error_handling_invalid_entity_type(self, preservation_manager) -> None:
    ...
    def test_load_existing_policies(self, temp_preservation_dir) -> None:
    ...
    def test_get_openproject_entity_data_users(self, preservation_manager) -> None:
        ...
        result = preservation_manager._get_openproject_entity_data(
            "test@example.com",
            "users",
        )
        assert result == {"id": 1, "email": "test@example.com"}
    ...
    def test_get_openproject_entity_data_projects(self, preservation_manager) -> None:
        """Test fetching project data from OpenProject."""
        # Mock OpenProject client methods
        mock_client = preservation_manager.openproject_client
        mock_client.find_record.return_value = {"id": 1, "identifier": "test-project"}
        mock_client.get_project_by_identifier.return_value = {
            "id": 1,
    ...
    def test_get_openproject_entity_data_work_packages(
        self,
        preservation_manager,
    ) -> None:
    ...
    def test_get_openproject_entity_data_custom_fields(
        self,
        preservation_manager,
    ) -> None:
        ...
        mock_client.get_custom_field_by_name.return_value = {
            "id": 1,
            "name": "Test Field",
        }
    ...
    def test_get_openproject_entity_data_unknown_type(
        self,
        preservation_manager,
    ) -> None:
    ...
    def test_extract_timestamp_from_string_value(self, preservation_manager) -> None:
        """Test timestamp extraction from string values."""
        # Test ISO format with microseconds
        timestamp_str = "2023-12-01T10:30:45.123456Z"
        result = preservation_manager._extract_timestamp_from_value(
            timestamp_str,
            "updated",
        )
    ...
    def test_extract_timestamp_from_dict_value(self, preservation_manager) -> None:
        """Test timestamp extraction from dictionary values."""
        # Test dict with timestamp field
        value = {"id": 1, "name": "Test", "updated_at": "2023-12-01T10:30:45Z"}
    ...
    def test_merge_field_values_latest_timestamp(self, preservation_manager) -> None:
    ...
    def test_merge_field_values_concatenate(self, preservation_manager) -> None:
    ...
    def test_merge_field_values_longest_value(self, preservation_manager) -> None:
    ...
    def test_analyze_preservation_status_with_real_data(
        self,
        preservation_manager,
    ) -> None:
        ...
        jira_changes = {"1": {"name": "Jira User", "description": "New description"}}
