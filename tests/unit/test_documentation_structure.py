...
class TestDocumentationStructure:
    ...
    def test_main_readme_exists(self, project_root: Path) -> None:
    ...
    def test_consolidated_docs_exist(self, project_root: Path) -> None:
    ...
    def test_architecture_guide_structure(self, project_root: Path) -> None:
    ...
    def test_workflow_guide_structure(self, project_root: Path) -> None:
