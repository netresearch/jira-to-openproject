...
class TestEnhancedUserAssociationMigrator:
    ...
    def migrator_with_mocks(self, mock_config, mock_clients, temp_data_dir, sample_user_mapping):
    ...
    def test_initialization_with_user_mapping(self, migrator_with_mocks):
        ...
        assert migrator_with_mocks.fallback_users == {
            "admin": 1,
            "migration": 999
        }
    ...
    @patch("src.utils.enhanced_user_association_migrator.config")
    def test_initialization_loads_mapping_from_file(self, mock_config, mock_clients, temp_data_dir):
    ...
    @patch("src.utils.enhanced_user_association_migrator.config")
    def test_initialization_handles_missing_mapping_file(self, mock_config, mock_clients, temp_data_dir):
    ...
    def test_create_enhanced_mappings(self, migrator_with_mocks, mock_clients):
        """Test creation of enhanced user mappings from basic mapping."""
        jira_client, op_client = mock_clients
        
        # Mock user info responses
        jira_client.get_user_info.side_effect = [
            {"accountId": "jdoe-123", "displayName": "John Doe", "emailAddress": "john.doe@example.com", "active": True},
            {"accountId": "jsmith-456", "displayName": "Jane Smith", "emailAddress": "jane.smith@example.com", "active": True},
            None,  # deleted.user
            {"accountId": "inactive-789", "displayName": "Inactive User", "emailAddress": "inactive@example.com", "active": False},
        ]
        
        op_client.get_user.side_effect = [
            {"id": 123, "login": "john.doe", "mail": "john.doe@company.com", "status": 1},
            {"id": 456, "login": "jane.smith", "mail": "jane.smith@company.com", "status": 1},
            {"id": 789, "login": "inactive.user", "mail": "inactive@company.com", "status": 3},
        ]
    ...
    def test_extract_user_associations_complete_issue(self, migrator_with_mocks, sample_jira_issue, mock_clients):
        ...
        jira_client.get_issue_watchers.return_value = [
            {"name": "watcher1", "accountId": "w1-123", "displayName": "Watcher One", "emailAddress": "w1@example.com", "active": True},
            {"name": "watcher2", "accountId": "w2-456", "displayName": "Watcher Two", "emailAddress": "w2@example.com", "active": True},
        ]
    ...
    def test_extract_user_associations_minimal_issue(self, migrator_with_mocks):
    ...
    def test_migrate_assignee_mapped_active_user(self, migrator_with_mocks, sample_enhanced_mapping):
    ...
    def test_migrate_assignee_inactive_user_with_fallback(self, migrator_with_mocks, sample_enhanced_mapping):
    ...
    def test_migrate_assignee_unmapped_user_with_fallback(self, migrator_with_mocks):
    ...
    def test_migrate_assignee_no_fallback_available(self, migrator_with_mocks):
    ...
    def test_migrate_assignee_none_data(self, migrator_with_mocks):
    ...
    def test_migrate_author_with_rails_preservation(self, migrator_with_mocks, sample_enhanced_mapping):
        ...
        result = migrator_with_mocks._migrate_author(
            reporter_data, creator_data, work_package_data, preserve_via_rails=True
        )
    ...
    def test_migrate_author_without_rails_preservation(self, migrator_with_mocks, sample_enhanced_mapping):
        ...
        result = migrator_with_mocks._migrate_author(
            reporter_data, None, work_package_data, preserve_via_rails=False
        )
    ...
    def test_migrate_author_prefer_reporter_over_creator(self, migrator_with_mocks, sample_enhanced_mapping):
        ...
        result = migrator_with_mocks._migrate_author(
            reporter_data, creator_data, work_package_data, preserve_via_rails=False
        )
        
        # Should use reporter (jane.smith) not creator (john.doe)
        assert work_package_data["author_id"] == 456  # jane.smith

    def test_migrate_author_fallback_on_unmapped(self, migrator_with_mocks):
    ...
    def test_migrate_author_no_data_uses_fallback(self, migrator_with_mocks):
        """Test author migration uses fallback when no author data available."""
        work_package_data = {}
        
        result = migrator_with_mocks._migrate_author(
            None, None, work_package_data, preserve_via_rails=False
        )
    ...
    def test_migrate_watchers_mixed_users(self, migrator_with_mocks, sample_enhanced_mapping):
    ...
    def test_migrate_watchers_no_valid_watchers(self, migrator_with_mocks):
    ...
    def test_migrate_watchers_empty_list(self, migrator_with_mocks):
    ...
    def test_get_fallback_user_priority_order(self, migrator_with_mocks):
    ...
    def test_get_fallback_user_no_fallbacks(self, migrator_with_mocks):
    ...
    def test_queue_rails_author_operation(self, migrator_with_mocks):
    ...
    def test_generate_author_preservation_script(self, migrator_with_mocks):
        """Test generation of Rails script for author preservation."""
        # Queue some operations
        migrator_with_mocks._queue_rails_author_operation("TEST-123", 456, {"username": "john.doe"})
        migrator_with_mocks._queue_rails_author_operation("TEST-456", 789, {"username": "jane.smith"})
        ...
        script = migrator_with_mocks._generate_author_preservation_script(work_package_mapping)
    ...
    def test_execute_rails_author_operations_success(self, migrator_with_mocks, mock_clients):
        ...
        result = migrator_with_mocks.execute_rails_author_operations(work_package_mapping)
        
        assert result["processed"] == 1
        assert result["errors"] == []
        assert len(migrator_with_mocks._rails_operations_cache) == 0  # Cache cleared

    def test_execute_rails_author_operations_failure(self, migrator_with_mocks, mock_clients):
    ...
    def test_execute_rails_author_operations_empty_cache(self, migrator_with_mocks):
    ...
    @patch("src.utils.enhanced_user_association_migrator.config")
    def test_save_enhanced_mappings(self, mock_config, migrator_with_mocks, temp_data_dir, sample_enhanced_mapping):
    ...
    def test_generate_association_report(self, migrator_with_mocks, sample_enhanced_mapping):
    ...
    def test_migrate_user_associations_full_workflow(self, migrator_with_mocks, sample_jira_issue, sample_enhanced_mapping, mock_clients):
        ...
        # Mock watchers response
        jira_client.get_issue_watchers.return_value = [
            {"name": "john.doe", "accountId": "jdoe-123", "displayName": "John Doe", "active": True},
        ]
        
        work_package_data = {"jira_key": "TEST-123"}
        
        result = migrator_with_mocks.migrate_user_associations(
            sample_jira_issue, work_package_data, preserve_creator_via_rails=True
        )
    ...
    def test_migrate_user_associations_with_warnings(self, migrator_with_mocks, sample_jira_issue, mock_clients):
        ...
        jira_client.get_issue_watchers.return_value = [
            {"name": "unknown.user", "accountId": "unknown-123", "displayName": "Unknown", "active": True},
        ]
        
        work_package_data = {"jira_key": "TEST-123"}
        
        result = migrator_with_mocks.migrate_user_associations(
            sample_jira_issue, work_package_data, preserve_creator_via_rails=False
        )
    ...
    def test_migrate_user_associations_watcher_fetch_failure(self, migrator_with_mocks, sample_jira_issue, sample_enhanced_mapping, mock_clients):
    ...
    def test_error_handling_in_user_info_fetch(self, migrator_with_mocks, mock_clients):
    ...
    def test_identify_fallback_users_error_handling(self, mock_clients):
