...
class TestEnhancedUserAssociationMigratorRetry:
    ...
    def test_get_jira_user_with_retry_success_first_attempt(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_success_after_retries(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_exhausted_retries(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_none_return_converted_to_error(self, migrator_instance):
        ...
        with patch('time.sleep'):
            with pytest.raises(JiraApiError, match="No user data returned"):
                migrator_instance._get_jira_user_with_retry("test.user")
        
        # Should make max_retries + 1 attempts (3 total: initial + 2 retries)
        assert migrator_instance.jira_client.get_user_info_with_timeout.call_count == 3

    def test_get_jira_user_with_retry_mixed_errors(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_invalid_username(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_custom_max_retries(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_max_retries_validation(self, migrator_instance):
        ...
        with pytest.raises(ValueError, match="max_retries must be a non-negative integer"):
            migrator_instance._get_jira_user_with_retry("test.user", max_retries="invalid")
    ...
    def test_get_jira_user_with_retry_exponential_backoff(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_jitter_applied(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_timeout_protection(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_fallback_method(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_concurrent_limiting(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_error_context_logging(self, migrator_instance):
    ...
    def test_get_jira_user_with_retry_warning_logs(self, migrator_instance):
