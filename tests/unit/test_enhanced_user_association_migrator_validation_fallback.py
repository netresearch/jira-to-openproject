...
class TestValidateRefreshedUser:
    ...
    def test_validate_active_user_with_consistent_data(
        self,
        migrator_with_validation,
        sample_jira_user_data,
        sample_current_mapping,
    ) -> None:
    ...
    def test_validate_missing_active_field_defaults_true(
        self,
        migrator_with_validation,
        sample_current_mapping,
    ) -> None:
    ...
    def test_validate_email_mismatch(
        self,
        migrator_with_validation,
        sample_jira_user_data,
        sample_current_mapping,
    ...
    def test_validate_account_id_mismatch(
        self,
        migrator_with_validation,
        sample_jira_user_data,
        sample_current_mapping,
    ...
    def test_validate_missing_previous_email_allows_any(
        self,
        migrator_with_validation,
        sample_jira_user_data,
    ) -> None:
    ...
    def test_validate_missing_previous_account_id_allows_any(
        self,
        migrator_with_validation,
        sample_jira_user_data,
    ) -> None:
    ...
    def test_validate_missing_metadata_allows_any(
        self,
        migrator_with_validation,
        sample_jira_user_data,
    ) -> None:
    ...
    def test_validate_missing_current_email_allows_any(
        self,
        migrator_with_validation,
        sample_current_mapping,
    ) -> None:
    ...
    def test_validate_missing_current_account_id_allows_any(
        self,
        migrator_with_validation,
        sample_current_mapping,
    ) -> None:
...
class TestApplyFallbackStrategy:
    ...
    def test_apply_skip_fallback_strategy(self, migrator_with_validation) -> None:
        """Test fallback strategy routes to skip method."""
        migrator_with_validation.fallback_strategy = "skip"

        with patch.object(
            migrator_with_validation,
            "_execute_skip_fallback",
            return_value=None,
        ) as mock_skip:
            result = migrator_with_validation._apply_fallback_strategy(
                "test.user",
                {"active": False},
                "user_inactive_in_jira",
            )

            mock_skip.assert_called_once_with("test.user", "user_inactive_in_jira", {})
            assert result is None

    def test_apply_assign_admin_fallback_strategy(
        self,
        migrator_with_validation,
        sample_jira_user_data,
    ) -> None:
        ...
        with patch.object(
            migrator_with_validation,
            "_execute_assign_admin_fallback",
    ...
    def test_apply_create_placeholder_fallback_strategy(
        self,
        migrator_with_validation,
        sample_jira_user_data,
    ) -> None:
        ...
        with patch.object(
            migrator_with_validation,
            "_execute_create_placeholder_fallback",
            return_value=expected_mapping,
        ) as mock_placeholder:
            result = migrator_with_validation._apply_fallback_strategy(
                "test.user",
    ...
    def test_apply_unknown_fallback_strategy_defaults_to_skip(
        self,
        migrator_with_validation,
        caplog,
    ) -> None:
        ...
        with patch.object(
            ...
            mock_skip.assert_called_once_with(
                "test.user",
                "unknown_strategy_unknown_strategy",
                {},
            )
            assert result is None
...
class TestExecuteSkipFallback:
    ...
    def test_skip_fallback_removes_existing_mapping(
        self,
        migrator_with_validation,
    ) -> None:
    ...
    def test_skip_fallback_handles_missing_mapping(
        self,
        migrator_with_validation,
    ) -> None:
    ...
    def test_skip_fallback_updates_metrics(self, migrator_with_validation) -> None:
...
class TestExecuteAssignAdminFallback:
    ...
    def test_assign_admin_fallback_creates_admin_mapping(
        self,
        mock_datetime,
        migrator_with_validation,
        sample_jira_user_data,
    ...
    def test_assign_admin_fallback_without_admin_config_falls_back_to_skip(
        self,
        migrator_with_validation,
    ) -> None:
        ...
        with patch.object(
            ...
            mock_skip.assert_called_once_with(
                "test.user",
                "no_admin_configured_validation_failed",
                {},
            )
            assert result is None

    def test_assign_admin_fallback_handles_none_jira_data(
        self,
        migrator_with_validation,
    ) -> None:
    ...
    def test_assign_admin_fallback_updates_metrics(
        self,
        migrator_with_validation,
    ) -> None:
...
class TestExecuteCreatePlaceholderFallback:
    ...
    @patch("src.utils.enhanced_user_association_migrator.datetime")
    def test_create_placeholder_fallback_creates_placeholder_mapping(
        self,
        mock_datetime,
        migrator_with_validation,
        sample_jira_user_data,
    ...
    def test_create_placeholder_fallback_handles_none_jira_data(
        self,
        migrator_with_validation,
    ) -> None:
    ...
    def test_create_placeholder_fallback_preserves_current_metadata(
        self,
        migrator_with_validation,
    ) -> None:
    ...
    def test_create_placeholder_fallback_updates_metrics(
        self,
        migrator_with_validation,
    ) -> None:
...
class TestRefreshUserMappingIntegration:
    ...
    def test_refresh_user_mapping_applies_fallback_on_validation_failure(
        self,
        migrator_with_validation,
    ) -> None:
        ...
        with (
            patch.object(
                migrator_with_validation,
                "_get_jira_user_with_retry",
                return_value=jira_user_data,
            ),
            patch.object(
                migrator_with_validation,
    ...
    def test_refresh_user_mapping_applies_fallback_on_user_not_found(
        self,
        migrator_with_validation,
    ) -> None:
    ...
    def test_refresh_user_mapping_continues_on_validation_success(
        self,
        migrator_with_validation,
        sample_jira_user_data,
    ) -> None:
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_validation_with_empty_jira_data(self, migrator_with_validation) -> None:
        """Test validation handles empty jira user data."""
        result = migrator_with_validation._validate_refreshed_user("test.user", {}, {})

        # Should pass because missing active defaults to True
        assert result["is_valid"] is True
        assert result["reason"] == "validation_passed"

    def test_fallback_strategy_with_none_jira_data(
        self,
        migrator_with_validation,
    ) -> None:
    ...
    def test_fallback_strategy_logs_execution(
        self,
        migrator_with_validation,
        caplog,
    ) -> None:
