...
class TestIdempotencyKeyManager:
    ...
    def test_parse_idempotency_key_from_headers(self):
    ...
    def test_parse_idempotency_key_empty_value(self):
        """Test generating new key for empty header value."""
        headers = {"X-Idempotency-Key": ""}
        key = self.manager.parse_idempotency_key(headers)
        assert len(key) == 36  # Should generate new UUID

    def test_parse_idempotency_key_too_long(self):
    ...
    def test_get_cached_result_redis_hit(self):
        ...
        test_data = {"test": "data"}
        cache_key = f"{self.manager._key_prefix}test-key"
    ...
    def test_get_cached_result_redis_miss_fallback_hit(self):
    ...
    def test_get_cached_result_complete_miss(self):
    ...
    def test_cache_result_redis_success(self):
    ...
    def test_cache_result_redis_error_fallback_success(self):
    ...
    def test_atomic_get_or_set_redis_existing(self):
    ...
    def test_atomic_get_or_set_redis_new(self):
    ...
    def test_atomic_get_or_set_fallback(self):
    ...
    def test_metrics_collection(self):
        ...
        new_key = self.manager.parse_idempotency_key()  # No headers = generate new key
    ...
    def test_cache_deserialization_error(self):
    ...
    def test_ttl_behavior(self):
        ...
        result = self.manager.get_cached_result("ttl-test")
