...
def sample_openproject_time_entry():
    ...
    return {
        ...
        "_meta": {"jira_work_log_id": "work_log_1", "source": "jira"},
    }
...
class TestTimeEntryMigratorInitialization:
    ...
    def test_initialization_loads_mappings_successfully(
        ...
        wp_mapping_data = {"wp1": {"jira_key": "PROJ-1", "openproject_id": 201}}
    ...
    def test_initialization_handles_op_client_failure(
        self,
        mock_jira_client,
        tmp_data_dir,
    ) -> None:
        ...
        # Act
        migrator = TimeEntryMigrator(
            mock_jira_client,
            mock_op_client_failed,
            tmp_data_dir,
        )
    ...
    def test_initialization_creates_data_directory(
        self,
        mock_jira_client,
        mock_op_client,
        tmp_path,
...
class TestTimeEntryMigratorValidation:
    ...
    def test_validate_time_entry(self, migrator, entry, expected_valid) -> None:
...
class TestTimeEntryMigratorExtraction:
    ...
    def test_extract_jira_work_logs_for_issues_success(
        ...
        mock_jira_client.get_work_logs_for_issue.side_effect = [
            ...
            [
                {"id": "work_log_2", "timeSpentSeconds": 1800, "issue_key": "PROJ-2"},
            ],  # PROJ-2
        ]
    ...
    def test_extract_tempo_time_entries_api_error(
        ...
        # Arrange
        mock_jira_client.get_tempo_time_entries.side_effect = Exception(
            "Tempo API Error",
        )
...
class TestTimeEntryMigratorOrchestration:
    ...
    def test_migrate_time_entries_for_issues_success(
        ...
        mock_jira_client.get_tempo_time_entries.return_value = [
            {"tempoWorklogId": "tempo_1"},
        ]

        mock_transformer_instance = MockTransformer.return_value
        mock_transformer_instance.batch_transform_work_logs.return_value = [
            sample_openproject_time_entry,
        ]
    ...
    def test_run_complete_migration_handles_errors(
        ...
        # Arrange
        issue_keys = ["PROJ-1"]
        mock_jira_client.get_work_logs_for_issue.side_effect = Exception(
            "Critical Error",
        )
...
class TestTimeEntryMigratorUtilities:
    ...
    def test_get_migration_summary(self, migrator) -> None:
    ...
    def test_migration_results_initialization(self, migrator) -> None:
...
class TestTimeEntryMigratorEdgeCases:
    ...
    def test_empty_issue_keys_list(self, migrator) -> None:
    ...
    def test_none_time_entries_input(self, migrator) -> None:
    ...
    def test_concurrent_file_access_handling(self, migrator, tmp_data_dir) -> None:
    ...
    def test_timing_measurements_accuracy(self, mock_datetime, migrator) -> None:
