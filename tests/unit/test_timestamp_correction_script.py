...
class TestTimestampCorrectionScript:
    ...
    def sample_work_packages(self):
        ...
        return [
            ...
            },
            {
                ...
                "customFields": {
                    "29": {"value": "PROJ-124"},
                    "10001": {"value": "2023-01-19T16:00:00Z", "type": "datetime"}  # Custom datetime field
                }
            },
            {
                "id": 3,
    ...
    def script_with_mocks(self, mock_clients):
        ...
        with patch("fix_timestamp_timezones.JiraClient", return_value=jira_client), \
    ...
    def test_initialization_dry_run(self, mock_clients):
    ...
    def test_initialization_apply_mode(self, mock_clients):
    ...
    def test_get_migrated_work_packages_success(self, script_with_mocks, sample_work_packages):
    ...
    def test_get_migrated_work_packages_empty_response(self, script_with_mocks):
    ...
    def test_get_migrated_work_packages_api_error(self, script_with_mocks):
    ...
    def test_needs_timezone_correction_utc_timestamp(self, script_with_mocks):
    ...
    def test_needs_timezone_correction_timezone_aware(self, script_with_mocks):
    ...
    def test_needs_timezone_correction_naive_timestamp(self, script_with_mocks):
    ...
    def test_needs_timezone_correction_invalid_timestamp(self, script_with_mocks):
    ...
    def test_correct_timestamp_utc_to_timezone(self, script_with_mocks):
    ...
    def test_correct_timestamp_naive_to_timezone(self, script_with_mocks):
        ...
        expected_dt = datetime(2023, 1, 15, 10, 30, 0, tzinfo=ZoneInfo("America/New_York"))
        assert result == expected_dt.isoformat()

    def test_correct_timestamp_convert_between_timezones(self, script_with_mocks):
        ...
        expected_dt = datetime(2023, 1, 15, 15, 30, 0, tzinfo=timezone.utc)
        tokyo_dt = expected_dt.astimezone(ZoneInfo("Asia/Tokyo"))
        assert result == tokyo_dt.isoformat()

    def test_correct_timestamp_invalid_format(self, script_with_mocks):
    ...
    def test_is_timestamp_field_by_type(self, script_with_mocks):
    ...
    def test_is_timestamp_field_by_value_format(self, script_with_mocks):
        """Test timestamp field detection by value format."""
        script = script_with_mocks
        
        # Valid timestamp values should be detected
        assert script._is_timestamp_field({"type": "string", "value": "2023-01-15T10:30:00Z"}) is True
        assert script._is_timestamp_field({"type": "string", "value": "2023-01-15T10:30:00+01:00"}) is True
    ...
    def test_process_work_package_with_corrections_dry_run(self, script_with_mocks):
        ...
        work_package = {
            ...
            "customFields": {
                "10001": {"value": "2023-01-17T12:00:00Z", "type": "datetime"}  # Needs correction
            }
        }
    ...
    def test_process_work_package_no_corrections_needed(self, script_with_mocks):
    ...
    def test_apply_corrections_success(self, script_with_mocks):
    ...
    def test_apply_corrections_api_error(self, script_with_mocks):
    ...
    def test_run_script_full_workflow_dry_run(self, script_with_mocks, sample_work_packages):
    ...
    def test_run_script_empty_work_packages(self, script_with_mocks):
    ...
    def test_run_script_with_batching(self, script_with_mocks, sample_work_packages):
